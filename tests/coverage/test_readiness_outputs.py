...
def _fixture_records() -> list[SourceMapRecord]:
    return [
        ...
        SourceMapRecord(
            ...
            plan_period="FY2024",
            cohort="state",
            source_url="https://example.gov/or-official.pdf",
            source_authority_tier="official",
            official_resolution_state="available_official",
            expected_plan_identity="OR-SERS",
        ...
        SourceMapRecord(
            ...
            plan_period="FY2024",
            cohort="state",
            source_url="https://example.gov/wa-official.pdf",
            source_authority_tier="official",
            official_resolution_state="available_official",
            expected_plan_identity="WA-SRS",
            observed_plan_identity="WA-SRS-ALT",
